...
function compute_μ_lower_bound(gp::GPE, x_L::Vector{Float64}, x_U::Vector{Float64}, theta_vec_train_squared::Vector{Float64}, theta_vec::Vector{Float64}, 
...
function calculate_components(α_train::Vector{Float64}, theta_vec_train_squared::Vector{Float64}, theta_vec::Vector{Float64}, x_train::Matrix{Float64}, x_L::Vector{Float64}, x_U::Vector{Float64}, n::Int, 
...
function compute_z_intervals(x_i, x_L::Vector{Float64}, x_U::Vector{Float64}, theta_vec::Vector{Float64}, n::Int, dx_L::Vector{Float64}, dx_U::Vector{Float64})
    z_i_L = 0.
